...
import { CalendarDays, Clock, Home, PhoneCallIcon, Star, User } from "lucide-react";
...
export function snakeCaseToTitleCase(str: string | undefined) {
  // Check if str is defined and is a string, otherwise return an empty string
