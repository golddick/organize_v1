  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-4 w-full my-10 text-center">
        ...
        {useCase === 'SCHOOL' ?  t("THIRD_STEP.SCHOOL.TITLE"):  t("THIRD_STEP.OTHERS.TITLE")}
        </h2>
      </div>
      <Form {...form}>
        <form
        ...
        >
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-muted-foreground">
                    {useCase === 'SCHOOL' ?  t("THIRD_STEP.SCHOOL.INPUTS.NAME"):  t("THIRD_STEP.OTHERS.INPUTS.NAME")}
                  </FormLabel>
                  <FormControl>
                    <Input
                      className="bg-muted"
          ...
          <UploadFile
            ...
            LabelText={useCase === 'SCHOOL'? t("THIRD_STEP.SCHOOL.INPUTS.FILE") : t("THIRD_STEP.OTHERS.INPUTS.FILE")}
          />
